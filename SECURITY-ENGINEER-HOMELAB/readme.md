...
Since I had the nmap scan finished and "confirmed" that SSH was open I first logged into through ssh and then tried logging into a fake user so that the logs could pick it up. I then tried brute forcing the fake account and got my Kali IP banned. 
